...
exports.getOrder = exports.deleteOrder = exports.addOrder = exports.getAllOrders = void 0;
const order_test_model_1 = __importDefault(require("../models/order.test.model"));
const orderModel = new order_test_model_1.default();
