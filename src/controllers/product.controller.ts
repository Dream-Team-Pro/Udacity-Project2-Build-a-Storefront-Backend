...
export const getAllProducts = async(req:Request, res:Response): Promise<void> => {
    try {
        ...
        res.send({
            message: "Success to get all products in table",
            data: {...products}
        })
    } catch (error) {
...
export const addProduct = async(req:Request, res:Response): Promise<void> => {
    try {
        ...
        res.send({
            message: "Success to Create a new product in table",
            data: {...addProduct}
        })
    } catch (error) {
...
export const deleteProduct = async(req: Request, res: Response): Promise<void> => {
    try {
        ...
        res.send({
            message: "Success to delete product from table",
            data: {...deleteProduct}
        })
    } catch (error) {
...
export const getProduct = async(req: Request, res: Response): Promise<void> => {
    try {
        ...
        res.send({
            message: "Success to get a product from table",
            data: {...getProduct}
        })
    } catch (error) {
        throw new Error('hello from delete error')
...
export const updateProduct = async(req:Request, res:Response): Promise<void> => {
    try {
        ...
        res.send({
            message: "Success to update the product in table",
            data: {...updateProduct}
        })
    } catch (error) {        
